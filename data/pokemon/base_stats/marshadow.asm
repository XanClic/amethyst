	...
	; tm/hm learnset
	tmhm TOXIC, HIDDEN_POWER, PROTECT, FRUSTRATION, RETURN, SLEEP_TALK, SHADOW_BALL, DOUBLE_TEAM, REST, THIEF, SWAGGER, STRENGTH, ENDURE, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH, HYPER_BEAM, PSYCH_UP
	;end
