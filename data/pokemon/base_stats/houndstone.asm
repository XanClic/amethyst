	...
	; tm/hm learnset
	tmhm MUD_SLAP, PROTECT, THIEF, ENDURE, SUNNY_DAY, RAIN_DANCE, SANDSTORM, DIG, SLEEP_TALK, REST, SHADOW_BALL, ROAR, RETURN, FRUSTRATION, SLEEP_TALK, HYPER_BEAM, HIDDEN_POWER, STRENGTH
	;end
