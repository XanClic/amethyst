	...
	; tm/hm learnset
	tmhm REST, SNORE, PROTECT, ATTRACT, SWIFT, ENDURE, SLEEP_TALK, FRUSTRATION, HIDDEN_POWER, STEEL_WING, FLAMETHROWER, SURF, THUNDERBOLT, THUNDER, FIRE_BLAST, SHADOW_BALL, FLY, HYPER_BEAM, SOLARBEAM
	;end
