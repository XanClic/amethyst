	...
	; tm/hm learnset
	tmhm HIDDEN_POWER, PROTECT, FRUSTRATION, RETURN, THIEF, SWIFT, ICY_WIND, ENDURE, RAIN_DANCE, DIG, SLEEP_TALK, REST, SHADOW_BALL, SLUDGE_BOMB, HYPER_BEAM, CURSE, CUT, PSYCH_UP
	;end
