...
BindDescription:
	db   "Umklammert Gegner"
	next "bis zu 5mal.@"

SlamDescription:
	db   "Trifft Gegner mit"
	next "Schwanz, Ranke...@"
...
MistDescription:
	db   "Verhindert Status-"
	next "veränderungen.@"

WaterGunDescription:
	db   "Greift mit Wasser"
	next "an.@"
