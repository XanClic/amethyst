...
Moves1:
	...
	move EFFECT_RAZOR_WIND,         80,  SPECIAL + MT_NORMAL,    75, 10,   0      ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0,   STATUS + MT_NORMAL,   100, 30,   0      ;SWORDS_DANCE
	...
	move EFFECT_FLY,                70, PHYSICAL + MT_FLYING,    95, 15,   0      ;FLY
	move EFFECT_TRAP_TARGET,        15, PHYSICAL + MT_NORMAL,    75, 20,   0      ;BIND
	move EFFECT_NORMAL_HIT,         80, PHYSICAL + MT_NORMAL,    75, 20,   0      ;SLAM
	move EFFECT_NORMAL_HIT,         35, PHYSICAL + MT_GRASS,    100, 10,   0      ;VINE_WHIP
	...
	move EFFECT_JUMP_KICK,          70, PHYSICAL + MT_FIGHTING,  95, 25,   0      ;JUMP_KICK
	...
	move EFFECT_NORMAL_HIT,         35, PHYSICAL + MT_NORMAL,    95, 35,   0      ;TACKLE
	move EFFECT_PARALYZE_HIT,       85, PHYSICAL + MT_NORMAL,   100, 15,  30      ;BODY_SLAM
	move EFFECT_TRAP_TARGET,        15, PHYSICAL + MT_NORMAL,    85, 20,   0      ;WRAP
	move EFFECT_RECOIL_HIT,         90, PHYSICAL + MT_NORMAL,    85, 20,   0      ;TAKE_DOWN
	move EFFECT_RAMPAGE,            90, PHYSICAL + MT_NORMAL,   100, 20,   0      ;THRASH
	...
	move EFFECT_POISON_MULTI_HIT,   25, PHYSICAL + MT_BUG,      100, 20,  20      ;TWINEEDLE
	move EFFECT_MULTI_HIT,          14, PHYSICAL + MT_BUG,       85, 20,   0      ;PIN_MISSILE
	...
	move EFFECT_DISABLE,             0,   STATUS + MT_NORMAL,    55, 20,   0      ;DISABLE
	move EFFECT_DEFENSE_DOWN_HIT,   40,  SPECIAL + MT_POISON,   100, 30,  10      ;ACID
	move EFFECT_BURN_HIT,           40,  SPECIAL + MT_FIRE,     100, 25,  10      ;EMBER
	move EFFECT_BURN_HIT,           95,  SPECIAL + MT_FIRE,     100, 15,  10      ;FLAMETHROWER
	move EFFECT_MIST,                0,   STATUS + MT_ICE,      100, 30,   0      ;MIST
	move EFFECT_NORMAL_HIT,         40,  SPECIAL + MT_WATER,    100, 25,   0      ;WATER_GUN
	move EFFECT_NORMAL_HIT,        120,  SPECIAL + MT_WATER,     80,  5,   0      ;HYDRO_PUMP
	move EFFECT_NORMAL_HIT,         95,  SPECIAL + MT_WATER,    100, 15,   0      ;SURF
	move EFFECT_FREEZE_HIT,         95,  SPECIAL + MT_ICE,      100, 10,  10      ;ICE_BEAM
	move EFFECT_FREEZE_HIT,        120,  SPECIAL + MT_ICE,       70,  5,  10      ;BLIZZARD
	...
	move EFFECT_RECOIL_HIT,         80, PHYSICAL + MT_FIGHTING,  80, 25,   0      ;SUBMISSION
	move EFFECT_FLINCH_HIT,         50, PHYSICAL + MT_FIGHTING,  90, 20,  30      ;LOW_KICK
	...
	move EFFECT_LEECH_HIT,          20,  SPECIAL + MT_GRASS,    100, 20,   0      ;ABSORB
	move EFFECT_LEECH_HIT,          40,  SPECIAL + MT_GRASS,    100, 10,   0      ;MEGA_DRAIN
	move EFFECT_LEECH_SEED,          0,   STATUS + MT_GRASS,     90, 10,   0      ;LEECH_SEED
	move EFFECT_SP_ATK_UP,           0,   STATUS + MT_NORMAL,   100, 40,   0      ;GROWTH
	...
	move EFFECT_RAMPAGE,            70,  SPECIAL + MT_GRASS,    100, 20,   0      ;PETAL_DANCE
	move EFFECT_SPEED_DOWN,          0,   STATUS + MT_BUG,       95, 40,   0      ;STRING_SHOT
	move EFFECT_STATIC_DAMAGE,      40,  SPECIAL + MT_DRAGON,   100, 10,   0      ;DRAGON_RAGE
	move EFFECT_TRAP_TARGET,        15,  SPECIAL + MT_FIRE,      70, 15,   0      ;FIRE_SPIN
	move EFFECT_PARALYZE_HIT,       40,  SPECIAL + MT_ELECTRIC, 100, 30,  10      ;THUNDERSHOCK
	move EFFECT_PARALYZE_HIT,       95,  SPECIAL + MT_ELECTRIC, 100, 15,  10      ;THUNDERBOLT
	move EFFECT_PARALYZE,            0,   STATUS + MT_ELECTRIC, 100, 20,   0      ;THUNDER_WAVE
	move EFFECT_THUNDER,           120,  SPECIAL + MT_ELECTRIC,  70, 10,  30      ;THUNDER
	...
	move EFFECT_FLY,                60, PHYSICAL + MT_GROUND,   100, 10,   0      ;DIG
	move EFFECT_TOXIC,               0,   STATUS + MT_POISON,    85, 10,   0      ;TOXIC
	...
	move EFFECT_HEAL,                0,   STATUS + MT_NORMAL,   100, 20,   0      ;RECOVER
	move EFFECT_DEFENSE_UP,          0,   STATUS + MT_NORMAL,   100, 30,   0      ;HARDEN
	move EFFECT_EVASION_UP,          0,   STATUS + MT_NORMAL,   100, 20,   0      ;MINIMIZE
	...
	move EFFECT_DEFENSE_UP_2,        0,   STATUS + MT_PSYCHIC,  100, 30,   0      ;BARRIER
	...
	move EFFECT_POISON_HIT,         20,  SPECIAL + MT_POISON,    70, 20,  40      ;SMOG
	...
	move EFFECT_BURN_HIT,          120,  SPECIAL + MT_FIRE,      85,  5,  10      ;FIRE_BLAST
	move EFFECT_NORMAL_HIT,         80, PHYSICAL + MT_WATER,    100, 15,   0      ;WATERFALL
	move EFFECT_TRAP_TARGET,        35, PHYSICAL + MT_WATER,     75, 10,   0      ;CLAMP
	move EFFECT_ALWAYS_HIT,         60,  SPECIAL + MT_NORMAL,   100, 20,   0      ;SWIFT
	move EFFECT_SKULL_BASH,        100, PHYSICAL + MT_NORMAL,   100, 15,   0      ;SKULL_BASH
	...
	move EFFECT_HEAL,                0,   STATUS + MT_NORMAL,   100, 10,   0      ;SOFTBOILED
	move EFFECT_JUMP_KICK,          85, PHYSICAL + MT_FIGHTING,  90, 20,   0      ;HI_JUMP_KICK
	move EFFECT_PARALYZE,            0,   STATUS + MT_NORMAL,    75, 30,   0      ;GLARE
	move EFFECT_DREAM_EATER,       100,  SPECIAL + MT_PSYCHIC,  100, 15,   0      ;DREAM_EATER
	move EFFECT_POISON,              0,   STATUS + MT_POISON,    55, 40,   0      ;POISON_GAS
	move EFFECT_MULTI_HIT,          15, PHYSICAL + MT_NORMAL,    85, 20,   0      ;BARRAGE
	move EFFECT_LEECH_HIT,          20, PHYSICAL + MT_BUG,      100, 15,   0      ;LEECH_LIFE
	move EFFECT_SLEEP,               0,   STATUS + MT_NORMAL,    75, 10,   0      ;LOVELY_KISS
	move EFFECT_SKY_ATTACK,        140, PHYSICAL + MT_FLYING,    90,  5,   0      ;SKY_ATTACK
	move EFFECT_TRANSFORM,           0,   STATUS + MT_NORMAL,   100, 10,   0      ;TRANSFORM
	move EFFECT_SPEED_DOWN_HIT,     20,  SPECIAL + MT_WATER,    100, 30,  10      ;BUBBLE
	move EFFECT_CONFUSE_HIT,        70, PHYSICAL + MT_NORMAL,   100, 10,  20      ;DIZZY_PUNCH
	move EFFECT_SLEEP,               0,   STATUS + MT_GRASS,    100, 15,   0      ;SPORE
	move EFFECT_ACCURACY_DOWN,       0,   STATUS + MT_NORMAL,    70, 20,   0      ;FLASH
	move EFFECT_PSYWAVE,             1,  SPECIAL + MT_PSYCHIC,   80, 15,   0      ;PSYWAVE
	move EFFECT_SPLASH,              0,   STATUS + MT_NORMAL,   100, 40,   0      ;SPLASH
	move EFFECT_DEFENSE_UP_2,        0,   STATUS + MT_POISON,   100, 40,   0      ;ACID_ARMOR
	move EFFECT_NORMAL_HIT,         90, PHYSICAL + MT_WATER,     85, 10,   0      ;CRABHAMMER
	...
	move EFFECT_HEAL,                0,   STATUS + MT_PSYCHIC,  100, 10,   0      ;REST
	...
	move EFFECT_THIEF,              40, PHYSICAL + MT_DARK,     100, 10, 100      ;THIEF
	...
	move EFFECT_SNORE,              40,  SPECIAL + MT_NORMAL,   100, 15,  30      ;SNORE
	...
	move EFFECT_SPEED_DOWN_2,        0,   STATUS + MT_GRASS,     85, 40,   0      ;COTTON_SPORE
	...
	move EFFECT_PARALYZE_HIT,      100,  SPECIAL + MT_ELECTRIC,  50,  5, 100      ;ZAP_CANNON
	...
	move EFFECT_MULTI_HIT,          25, PHYSICAL + MT_GROUND,    80, 10,   0      ;BONE_RUSH
	move EFFECT_LOCK_ON,             0,   STATUS + MT_NORMAL,   100,  5,   0      ;LOCK_ON
	move EFFECT_RAMPAGE,            90, PHYSICAL + MT_DRAGON,   100, 15,   0      ;OUTRAGE
	...
	move EFFECT_HEAL,                0,   STATUS + MT_NORMAL,   100, 10,   0      ;MILK_DRINK
	move EFFECT_PARALYZE_HIT,       65, PHYSICAL + MT_ELECTRIC, 100, 20,  30      ;SPARK
	move EFFECT_FURY_CUTTER,        10, PHYSICAL + MT_BUG,       95, 20,   0      ;FURY_CUTTER
	...
	move EFFECT_RAPID_SPIN,         20, PHYSICAL + MT_NORMAL,   100, 40,   0      ;RAPID_SPIN
	...
	move EFFECT_FUTURE_SIGHT,       80,  SPECIAL + MT_PSYCHIC,   90, 15,   0      ;FUTURE_SIGHT
