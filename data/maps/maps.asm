...
MapGroup_Ecruteak:
	...
	map EcruteakGym, TILESET_ECRUTEAK_GYM, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map EcruteakPoltchageistHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
