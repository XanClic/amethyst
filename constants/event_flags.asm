...
; Medium
	const EVENT_BEAT_HEX_MANIAC_FINE
	const EVENT_BEAT_HEX_MANIAC_CLARA
	const EVENT_BEAT_HEX_MANIAC_BETHANY
	const EVENT_BEAT_HEX_MANIAC_MARGRET
	const EVENT_BEAT_HEX_MANIAC_ETHEL
	const EVENT_BEAT_HEX_MANIAC_REBECCA
	const EVENT_BEAT_HEX_MANIAC_DORIS
; Skier
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_WITCHER_CHRISTIAN
...
; Johto people
	...
	const EVENT_BURNED_TOWER_SOPHIE
...
; New to Crystal
	...
	const EVENT_MEWTWO
	const EVENT_MEW
	const EVENT_GOT_POLTCHAGEIST
	const EVENT_TREVENANT
	const EVENT_MARSHADOW
