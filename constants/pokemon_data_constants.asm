...
DEF CAUGHT_TIME_MASK  EQU %10000000
...
rsreset
DEF EGGBANK_SPECIES            rw
DEF EGGBANK_MOVES              rb NUM_MOVES * 2
DEF EGGBANK_OT_ID              rw
DEF EGGBANK_EXP                rb 3
DEF EGGBANK_DVS                rw
DEF EGGBANK_HAPPINESS          rb
DEF EGGBANK_POKERUS            rb
DEF EGGBANK_CAUGHTDATA         rw
rsset EGGBANK_CAUGHTDATA
DEF EGGBANK_CAUGHTTIME         rb
DEF EGGBANK_CAUGHTGENDER       rb
rsset EGGBANK_CAUGHTDATA
DEF EGGBANK_CAUGHTLEVEL        rb
DEF EGGBANK_CAUGHTLOCATION     rb
DEF EGGBANK_LEVEL              rb
DEF EGGBANK_STRUCT_LENGTH EQU _RS

assert(EGGBANK_STRUCT_LENGTH == 22)
